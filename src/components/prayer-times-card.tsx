...
function DateFader({ gregorian, hijri }: { gregorian: string, hijri: string }) {
    ...
    return (
        <CardTitle 
            className="pt-1 text-sm text-black font-body h-6 flex items-center justify-center text-center w-full"
            style={{ 
                opacity: opacity,
    ...
    <Card className="w-full w-[20rem] mx-auto shadow-2xl shadow-primary/10 bg-card/40 border-primary/20">
      <CardHeader className="text-center pb-2 relative">
        ...
        <div className="flex flex-col items-center space-y-2 pt-6">
            ...
            <div className="bg-mint-green/30 text-primary-foreground rounded-lg p-1 border border-black flex flex-col items-center space-y-0 mx-auto w-4/5">
